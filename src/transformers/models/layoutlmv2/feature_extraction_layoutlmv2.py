...
class LayoutLMv2FeatureExtractor(FeatureExtractionMixin, ImageFeatureExtractionMixin):
    ...
    Args:
        ...
        tess_config (`Optional[str]`, *optional*):
            Optional arguments forwarded to `config` parameter when calling Tesseract. Eg. to change psm
            modes. '--psm 7'
    ...
    def __init__(self, do_resize=True, size=224, resample=Image.BILINEAR, apply_ocr=True, ocr_lang=None,  tess_config="", **kwargs):
